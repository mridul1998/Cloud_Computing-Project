...
export declare type StartupPredictionInputValues = {
    Field0?: string;
    Field1?: string;
    Field2?: string;
    Field3?: string;
...
export declare type StartupPredictionValidationValues = {
...
export declare type StartupPredictionOverridesProps = {
    StartupPredictionGrid?: FormProps<GridProps>;
...
export declare type StartupPredictionProps = React.PropsWithChildren<{
    overrides?: StartupPredictionOverridesProps | undefined | null;
} & {
    onSubmit: (fields: StartupPredictionInputValues) => void;
    onCancel?: () => void;
    onChange?: (fields: StartupPredictionInputValues) => StartupPredictionInputValues;
    onValidate?: StartupPredictionValidationValues;
} & React.CSSProperties>;
export default function StartupPrediction(props: StartupPredictionProps): React.ReactElement;
